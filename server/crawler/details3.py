...
SELECT
    ...
    m.codigoMarca || '/' ||
    m.value || '/' ||
    y.value AS uri,  -- Agora usa o formato 'anoModelo-typeGas'
    m.codigoTipoVeiculo,
    m.codigoMarca,
    ...
    async with semaphore:
        try:
            ...
            if data.get("success") and "data" in data:
                ...
                # Aguarde 5 segundos antes da próxima requisição
...
async def main():
    ...
    async with httpx.AsyncClient() as client:
        ...
        tasks = [
        fetch_details(client, url, type_id, brand_id, model_id, year_int)  # Agora só 5 parâmetros
